                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> DataInicio </th><td> <?php echo e($selectprocess->dataInicio); ?> </td></tr><tr><th> DataFim </th><td> <?php echo e($selectprocess->dataFim); ?> </td></tr><tr><th> Ativo </th><td> <?php echo e($selectprocess->ativo); ?> </td></tr>
                                </tbody>
                            </table>
                        </div>
